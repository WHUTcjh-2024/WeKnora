...
func TestConversationRoutesDeclareChatCapability(t *testing.T) {
	...
	cases := []struct {
		...
		{http.MethodGet, "/api/v1/sessions/:id/sandbox/files"},
		{http.MethodGet, "/api/v1/sessions/:id/sandbox/files/content"},
		{http.MethodPost, "/api/v1/sessions/:session_id/sandbox/files"},
		{http.MethodPatch, "/api/v1/sessions/:id/sandbox/files"},
		{http.MethodDelete, "/api/v1/sessions/:id/sandbox/files"},
